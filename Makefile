main: main.cpp include/FunctionParser.h FunctionParser.o AddFunction.o \
	BaseFunction.o ConstantFunction.o CosFunction.o DivideFunction.o \
	IndependentVariable.o LnFunction.o MinusFunction.o MultiplyFunction.o \
	PiecewiseFunction.o PowerFunction.o Segment.o SinFunction.o TanFunction.o
	
	g++ -o main -I ./include main.cpp FunctionParser.o AddFunction.o \
		BaseFunction.o ConstantFunction.o CosFunction.o DivideFunction.o \
		IndependentVariable.o LnFunction.o MinusFunction.o MultiplyFunction.o \
		PiecewiseFunction.o PowerFunction.o Segment.o SinFunction.o \
		TanFunction.o -std=c++11 -lm
...
CosFunction.o: src/CosFunction.cpp include/CosFunction.h MultiplyFunction.o \
	ConstantFunction.o SinFunction.o
	g++ -I ./include src/CosFunction.cpp -c -std=c++11

DivideFunction.o: src/DivideFunction.cpp include/DivideFunction.h \
	MinusFunction.o CosFunction.o SinFunction.o MultiplyFunction.o
...
LnFunction.o: src/LnFunction.cpp include/LnFunction.h MultiplyFunction.o \
	DivideFunction.o ConstantFunction.o
...
PowerFunction.o: src/PowerFunction.cpp include/PowerFunction.h AddFunction.o \
	MultiplyFunction.o ConstantFunction.o LnFunction.o
...
TanFunction.o: src/TanFunction.cpp include/TanFunction.h MultiplyFunction.o \
	ConstantFunction.o DivideFunction.o PowerFunction.o
	g++ -I ./include src/TanFunction.cpp -c -std=c++11

clean:
	rm AddFunction.o BaseFunction.o ConstantFunction.o CosFunction.o \
		DivideFunction.o FunctionParser.o IndependentVariable.o LnFunction.o \
		MinusFunction.o MultiplyFunction.o PiecewiseFunction.o PowerFunction.o \
		Segment.o SinFunction.o TanFunction.o main
